...
#define Z_LEVEL_SUB_BEACH							1
#define Z_LEVEL_MAIN_PLATEAU						2
#define Z_LEVEL_TOP_CLIFFS							4
/*
...
/datum/map/sand_circles
	name = "Sand Circles"
	full_name = "IRIS Construction Zone 'Sand Circles'"
	path = "sand_circles"

	lobby_icon = 'icons/misc/title.dmi'
	lobby_screens = list("mockingjay00")

	zlevel_datum_type = /datum/map_z_level/sand_circles

	station_name  = "IRIS CZ Sand Circles"
	station_short = "IRIS SC"
	dock_name     = "IRIS SC Train Station"
...
/datum/map/sand_circles/perform_map_generation()
	new /datum/random_map/automata/cave_system(null, 1, 1, Z_LEVEL_SUB_BEACH, world.maxx, world.maxy) // Create the mining Z-level.
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_SUB_BEACH, 64, 64)         // Create the mining ore distribution map.

	new /datum/random_map/automata/cave_system(null, 1, 1, Z_LEVEL_MAIN_PLATEAU, world.maxx, world.maxy) // Create the mining Z-level.
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_MAIN_PLATEAU, 64, 64)         // Create the mining ore distribution map.

	new /datum/random_map/automata/cave_system(null, 1, 1, Z_LEVEL_TOP_CLIFFS, world.maxx, world.maxy) // Create the mining Z-level.
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_TOP_CLIFFS, 64, 64)         // Create the mining ore distribution map.
	return 1

/datum/map_z_level/sand_circles/sub
	z = Z_LEVEL_SUB_BEACH
	name = "Beach"
...
/datum/map_z_level/sand_circles/main
	z = Z_LEVEL_MAIN_PLATEAU
	name = "Plateau"
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	transit_chance = 0
	base_turf = /turf/simulated/open

/datum/map_z_level/sand_circles/top
	z = Z_LEVEL_TOP_CLIFFS
	name = "Cliffs"
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	transit_chance = 0
	base_turf = /turf/simulated/mineral/floor/cave
